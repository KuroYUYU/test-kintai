...
<div class="index">
    ...
    <div class="index__tabs">
        <a href="{{ route('stamp_correction_request.index', ['page' => 'pending']) }}" class="index__tab @if ($page === 'pending') index__tab--active @endif">承認待ち</a>

        <a href="{{ route('stamp_correction_request.index', ['page' => 'approved']) }}" class="index__tab @if ($page === 'approved') index__tab--active @endif">承認済み</a>
    </div>
